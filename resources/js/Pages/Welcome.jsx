                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-12">
                            ...
                            <div className="lg:w-1/2">
                                ...
                                <p className="text-gray-600 mb-6">
                                    ...
                                    the ultimate fitness experience. Our commitment to sustainability extends to every aspect of our operations.
                                </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                            ...
                            {/* <div>
                                ...
                                <ul className="space-y-2">
                                    <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Workout Tracking</Link></li>
                                    <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Nutrition Plans</Link></li>
                                    <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Community Support</Link></li>
                                    <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Progress Analytics</Link></li>
                                </ul>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2">
                                    ...
                                    <li><Link href="#" className="text-gray-400 hover:text-white transition-colors">Developers</Link></li>
                                </ul>
                            </div>
                        </div>
