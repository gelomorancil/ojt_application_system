...
const Forms = () => {
  ...
  const loadForms = async () => {
    try {
      setLoading(true);
      const response = await fetch(route('api.forms.index', { collegeId: selectedCollege }));
      ...
      <div className="container mx-auto p-4">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="md:w-2/3">
            <h2 className="text-xl font-bold mb-4">Uploaded Templates</h2>
            
            {loading ? (
              <p>Loading templates...</p>
            ) : forms.length === 0 ? (
              <p>No templates available for this college.</p>
            ) : (
